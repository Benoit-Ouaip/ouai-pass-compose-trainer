...
export const scenarios: Scenario[] = [
    ...
    exercises: [
      {
        ...
        correctAnswer: "sommes lavé",
        explanation: "Se laver est pronominal et se conjugue avec être. Ici, 'les mains' est le COD du verbe placé après → pas d'accord : nous nous sommes lavé les mains.",
        choices: ["sommes lavé", "avons lavé", "étions lavé"]
      },
      {
        id: 32,
  ...
  },
  {
    ...
    exercises: [
      ...
      {
        id: 129,
        presentSentence: "Vous comprenez l'énigme.",
        verbToConjugate: "comprenez",
        correctAnswer: "avez compris",
        explanation: "Comprendre se conjugue avec avoir : vous avez compris.",
        choices: ["avez compris", "êtes compris", "vous êtes compris"]
      },
      {
        id: 130,
