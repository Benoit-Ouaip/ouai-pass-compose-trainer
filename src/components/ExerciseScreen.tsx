...
const ExerciseScreen = ({
  ...
  return <div className="w-full min-h-screen flex flex-col px-4 py-2">
      {/* Header */}
      <div className="flex items-center justify-between mb-2">
        <Button variant="outline" onClick={onBack} className="border-primary text-primary hover:bg-primary/10">
          ← Retour
        </Button>
        <h2 className="font-bold text-ouaip-dark-blue text-xl text-white">
          {scenarioTitle}
        </h2>
      ...
      {/* Exercise */}
      <div className="ouaip-card p-6 mb-2 flex-grow flex items-center justify-center">
        {renderExercise()}
      </div>
