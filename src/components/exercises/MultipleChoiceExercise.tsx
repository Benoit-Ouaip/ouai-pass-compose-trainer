...
const MultipleChoiceExercise = ({
  ...
  const createDisplaySentence = () => {
    if (isAnswered && isCorrect) {
      ...
      return exercise.presentSentence.replace(new RegExp(`\\b${exercise.verbToConjugate}\\b`, 'gi'), `<span style="background: white; padding: 8px 16px; border-radius: 8px; min-width: 160px; display: inline-block; color: #64748b; font-style: italic; font-size: 0.75rem;">Dépose ici</span>`);
    }
  };
